        ...
        <section className='bg-white'>
            <div className='max-w-6xl mx-auto pb-24 px-5 sm:px-9 md:px-12 lg:px-16 xl:px-10'>
                <div className='mb-6'>
                    ...
                    <p className='md:text-xl text-lg font-medium text-[#ff715b] text-center pt-4'>dev.mahedihasan@gmail.com</p>
                </div>
                    ...
                    <div className='md:w-[55%] shadow-lg md:p-8 p-4 rounded-2xl'>
                        <div className=''>
                            ...
                            <div className=' mb-4'>
                                ...
                                <input type="email" placeholder="Your Name" className="input input-bordered w-full max-w-lg" />
                            </div>
                            <div className='mb-8'>
                                <p className='text-[#2f2f2f] text-lg ml-1 mb-2'>Message</p>
                                <input type="email" placeholder="Your Name" className="input input-bordered w-full max-w-lg py-10" />
                            </div>
