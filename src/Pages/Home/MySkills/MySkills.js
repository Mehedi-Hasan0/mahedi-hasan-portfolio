                        ...
                        <aside className='md:w-[60%]'>
                            <div>
                                <div className='flex flex-wrap gap-4 md:mb-14 mb-10 justify-center md:justify-start'>
                                    <p className='p-2 bg-[#121E27] text-white inline-block '>Javascript</p>
                                    ...
                                    <p className='p-2 bg-[#121E27] text-white inline-block tooltip' data-tip='Frontend Css Framework'>Bootstrap</p>
